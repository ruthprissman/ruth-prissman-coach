        ...
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          <div className="border-r-4 border-blue-400 bg-blue-50 p-6 rounded-lg shadow-sm">
            <div className="font-heebo text-lg md:text-xl leading-snug text-gray-800">
              <p>"התופעה הזו מוכרת וכואבת, להרבה מאוד נשים. היא נובעת ממקום גבוה וטהור. תמיד למדנו שתפילה היא מרוממת, ושהמילים קדושות כל כך. וקיבלנו איזו תחושה, שאם לא כיוונו את הכוונה הפנימית של כל מילה, אם לא התנתקנו מההווה הגשמי והעמוס שלנו, אז... מה 'שווה' התפילה שלנו? <span className="font-bold">אבל האמת? הפוכה לגמרי!</span> הקב"ה רוצה אותנו מתפללות מאיפה שאנחנו. הוא מחכה שנכניס את החיים האמיתיים שלנו, הגשמיים, הפשוטים, לתוך התפילה! את העייפות, את הדאגות, את האורז שנשרף והכתם שלא יורד. את הילד שיצא לטיול. את ההודיה על ציון טוב, את השמחות הקטנות של היום יום. להכניס את כולם לתוך המילים. <span className="font-bold">למצוא אותם במילים."</span></p>
            </div>
          </div>
        </div>
      </div>
