...
import { LogOut, Home, Users, Calendar, ChevronRight, ChevronLeft, Menu, FileText, BookOpenText, BookIcon, Clock, CreditCard, ChartBar, Settings, GraduationCap, Mail, Paintbrush, PenLine, Combine } from 'lucide-react';
