...
import { LogOut, Home, Users, Calendar, ChevronRight, ChevronLeft, Menu, FileText, BookOpenText, BookIcon, Clock, CreditCard, ChartBar, Settings, GraduationCap, Mail, Paintbrush, PenLine, Combine, Send } from 'lucide-react';
...
const AdminLayout: React.FC<AdminLayoutProps> = ({ children, title }) => {
  ...
  const navItems = [
    ...
    { label: 'מייל שיווקי מותאם', icon: <Send className="ml-2 h-5 w-5" />, path: '/admin/marketing-email' },
