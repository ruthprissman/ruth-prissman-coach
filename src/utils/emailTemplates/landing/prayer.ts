...
<body>
  <table class="wrapper" dir="rtl" align="right">
    ...
    <!-- Hero Section -->
    <tr>
       <td bgcolor="#2d3748" background="${content.hero.heroImageUrl}" style="background-color:#2d3748; background-image: url('${content.hero.heroImageUrl}'); background-size: cover; background-position: center; background-repeat: no-repeat;">
         <!-- Gradient overlay -->
         <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" align="center" style="background: linear-gradient(135deg, rgba(16, 37, 58, 0.95), rgba(30, 20, 60, 0.95));">
           <tr>
