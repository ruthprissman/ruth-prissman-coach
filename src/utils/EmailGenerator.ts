  ...
  private generateEmailLinks(links: Array<{id: number, fixed_text: string, url: string}>): string {
    ...
    for (const link of links) {
      try {
        ...
        // Start paragraph tag with proper styling for centered links - using Heebo font with !important
        linksHtml += '<p class="link-p" style="font-family: \'Heebo\', Arial, sans-serif !important; font-size: 14px; text-align: center; margin-bottom: 20px; color: #4A148C; font-weight: bold; text-shadow: 1px 1px 3px rgba(255, 255, 255, 0.7); direction: rtl;">';
        ...
        if (link.url && link.url.startsWith('https://wa.me/')) {
          ...
          linksHtml += '<a href="' + safeUrl + '" target="_blank" rel="noopener noreferrer" ' +
                      'style="display: inline-flex; align-items: center; color: #4A148C; font-weight: bold; text-decoration: none; text-shadow: 1px 1px 3px rgba(255, 255, 255, 0.7); font-family: \'Heebo\', Arial, sans-serif !important;">' +
        ...
        // Regular link with URL
          ...
          linksHtml += '<a href="' + safeUrl + '" target="_blank" rel="noopener noreferrer" ' +
                      'style="color: #4A148C; font-weight: bold; text-decoration: none; text-shadow: 1px 1px 3px rgba(255, 255, 255, 0.7); font-family: \'Heebo\', Arial, sans-serif !important;">' +
                      linkText + '</a>';
        ...
        // Text only (no URL - like notes or call-to-actions)
          ...
          linksHtml += '<strong style="color: #4A148C; text-shadow: 1px 1px 3px rgba(255, 255, 255, 0.7); font-family: \'Heebo\', Arial, sans-serif !important;">' + 
                      linkText + '</strong>';
