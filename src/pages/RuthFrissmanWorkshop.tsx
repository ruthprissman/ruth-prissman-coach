  ...
  const faqData = [
    {
      ...
      answer: "כל סדנה היא באורך אחר ומותאמת לצרכי הקבוצה. הזמן הממוצע הוא שעה וחצי עד שעתיים"
    },
    {
      question: "כמה משתתפות יכולות להיות בסדנה?",
      answer: "אפשרות להתאמת הסדנה לכל גודל של קבוצה, מקבוצה קטנה ואינטימית להרצאה מרובת משתתפים"
    },
    {
