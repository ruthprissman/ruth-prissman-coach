        ...
        >
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl lg:text-2xl mb-4 text-brand-turquoise">
              ...
              <div className="flex justify-center mb-12">
                <Button 
                  size="lg"
                  className="bg-brand-purple text-white hover:bg-brand-purple/90 px-8 py-3 text-lg rounded-full shadow-lg"
            ...
            <div className="max-w-3xl mx-auto text-center">
              ...
              <div className="text-lg leading-relaxed mb-8 text-muted-foreground">
                <p className="mb-6">
                  ...
                  לאחר שנים של ליווי נשים במסע הרגשי שלהן, גיליתי שרבות מתקשות להתחבר לתפילה בצורה משמעותית.
                </p>
                <p className="mb-6">
                  המילים המוכרות הופכות אוטומטיות, והלב נשאר מחוץ לתהליך. זה המקום שממנו נולדו הסדנאות שלי - 
                  ליצור גשר חדש בין המילים הקדושות ללב הפועם.
                </p>
                <div className="grid md:grid-cols-3 gap-6 mt-8">
                  <div className="flex items-center gap-3 text-right">
                    <div className="w-3 h-3 bg-brand-purple rounded-full flex-shrink-0"></div>
                    <span>מאמנת רגשית מוסמכת</span>
                  </div>
                  <div className="flex items-center gap-3 text-right">
                    <div className="w-3 h-3 bg-brand-purple rounded-full flex-shrink-0"></div>
                  ...
                  <div className="flex items-center gap-3 text-right">
                    <div className="w-3 h-3 bg-brand-purple rounded-full flex-shrink-0"></div>
                    <span>מפתחת תפילה משמעותית</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="grid md:grid-cols-2 gap-8">
                ...
                <Card className="border-2 border-brand-purple/20 hover:border-brand-purple/40 transition-colors">
                  <CardHeader>
                    <CardTitle className="text-xl text-text-primary">מילים מהלב - יסודות החיבור לתפילה</CardTitle>
                    <CardDescription>סדנת יסוד לגילוי המשמעות האישית בתפילה</CardDescription>
                  </CardHeader>
                  <CardContent>
                    <p className="mb-4 text-muted-foreground">
                      סדנה מעמיקה שתלמד אותך לגלות את המשמעות האישית שלך בתפילות המוכרות, 
                      ולפתח דרכים חדשות להתחבר למילים עתיקות הזמן.
                    </p>
                    
                    <div className="mb-4">
                      <h4 className="font-semibold mb-2 text-text-primary">מה תרכשי בסדנה:</h4>
                      <ol className="list-decimal list-inside space-y-1 text-sm text-muted-foreground">
                        <li>כלים מעשיים לחיבור רגשי לתפילה</li>
                    ...
                    <div className="space-y-2 text-sm">
                      ...
                      <p><strong>משך:</strong> 2.5 שעות</p>
