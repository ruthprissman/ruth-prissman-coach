    ...
    try {
      ...
      for (const link of links) {
        try {
          ...
          // Add line breaks after punctuation marks - only for periods and exclamation marks
          linkText = linkText.replace(/([.!])\s*/g, '$1<br>');
          
          // Start paragraph tag with styles from template
          linksHtml += '<p style="font-family: ' + linkStyles.fontFamily + ' !important; font-size: ' + linkStyles.fontSize + ' !important; text-align: center !important; margin: 0 0 15px 0 !important; color: ' + linkStyles.color + ' !important; font-weight: ' + linkStyles.fontWeight + ' !important; direction: rtl !important; line-height: 1.4 !important;">';
          ...
          if (link.url && link.url.startsWith('https://wa.me/')) {
            ...
            const iconSize = Math.min(parseInt(linkStyles.fontSize) * 0.9, 28);
            
            linksHtml += '<a href="' + safeUrl + '" target="_blank" rel="noopener noreferrer" ' +
                        'style="display: inline-flex !important; align-items: center !important; color: ' + linkStyles.color + ' !important; font-weight: ' + linkStyles.fontWeight + ' !important; text-decoration: none !important; font-family: ' + linkStyles.fontFamily + ' !important; font-size: ' + linkStyles.fontSize + ' !important;">' +
                        '<svg viewBox="0 0 24 24" width="' + iconSize + '" height="' + iconSize + '" fill="#25D366" style="margin-left: 8px; flex-shrink: 0;">' +
