    ...
    try {
      ...
      if (existingSubscriber) {
        if (existingSubscriber.is_subscribed) {
          // Resend the guide
          const pdfUrl = 'https://uwqwlltrfvokjlaufguz.supabase.co/storage/v1/object/public/site_file/PRYGUID.pdf';
          ...
          className="flex-col md:flex-row md:items-center items-start">
            ...
            className="md:w-[60%]">
              ...
              <p style={{ marginBottom: '1rem' }}>
                ולפעמים, כשכבר יש כמה דקות של שקט – את לא בטוחה מה את <strong>צריכה</strong> להגיד, ומה את <strong>רוצה</strong> להגיד?
              </p>
      ...
      <section dir="rtl" style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            <p style={{ marginBottom: '1.5rem' }}>
              <strong>אני רוצה לגלות לך סוד</strong>: אני לא באה להטיף מוסר, וגם לא לספר סיפורי צדיקים. אני לא רבנית בכלל – אני באה מעולם הנפש והלב.
            </p>
            <p style={{ marginBottom: '1.5rem' }}>
